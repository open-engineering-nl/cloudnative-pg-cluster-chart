...
We have now migrated to https://codeberg.org/open-engineering/cloudnative-pg-cluster-chart
...
helm repo add cnpg-wrapper https://open-engineering-nl.github.io/cloudnative-pg-cluster-chart
